...
if (checkRoot && nativeBindingPath.toLowerCase().includes(checkRoot.toLowerCase())) {
...
'@
  ...
  $mcpStartInfo.Arguments = "`"$bootstrapScript`" `"$installedAsar`" `"$mcpDbPath`" `"$smokeRepoDir`" `"$ProjectRoot`""
