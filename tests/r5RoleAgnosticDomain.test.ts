...
describe('R5A — Role-Agnostic Agent Fabric Domain Foundation', () => {
  ...
  it('7. ProviderAccount can be created without role', () => {
    ...
    const acct: ProviderAccount = {
      ...
      credential_ref: null,
      profile_ref: 'native-profile://gemini/profile-gemini-prod',
      enabled: true,
      priority: 10,
      health_status: 'AVAILABLE',
      cooldown_until: null,
    ...
    expect(loaded?.profile_ref).toBe('native-profile://gemini/profile-gemini-prod');
  });
  ...
  it('8. AgentAssignment stores role/profile/provider/account/resource as distinct fields', () => {
    ...
    const acct: ProviderAccount = {
      ...
      credential_ref: 'wincred://agentforge/openai/key-9876',
      profile_ref: null,
      enabled: true,
      priority: 1,
      health_status: 'AVAILABLE',
  ...
  it('10. Duplicate account slot index is rejected by unique constraint', () => {
    ...
    const acct: ProviderAccount = {
      ...
      label: 'Slot Account',
      auth_mode: 'API_CREDENTIAL',
      credential_ref: 'wincred://agentforge/test/account-key',
      profile_ref: null,
      enabled: true,
      priority: 1,
      health_status: 'AVAILABLE',
  ...
  it('17. Legacy provider resource lookup and account linkage queries function seamlessly', () => {
    ...
    const acct1: ProviderAccount = {
      ...
      label: 'Acct 1',
      auth_mode: 'API_CREDENTIAL',
      credential_ref: 'wincred://agentforge/test/cred-1',
      profile_ref: null,
      enabled: true,
      priority: 10,
      health_status: 'AVAILABLE',
    ...
    const acct2: ProviderAccount = {
      ...
      label: 'Acct 2',
      auth_mode: 'API_CREDENTIAL',
      credential_ref: 'wincred://agentforge/test/cred-2',
      profile_ref: null,
      enabled: true,
      priority: 5,
      health_status: 'AVAILABLE',
  ...
  // 24. role profile A + agent profile belongs to role profile B rejected
